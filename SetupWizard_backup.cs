...
public class SetupWizard
{
    ...
    public async Task RunAsync()
    {
        ...
        Console.WriteLine("โ•‘           HoNfigurator .NET - First Time Setup               โ•‘");
        ...
        Console.WriteLine("โ•โ•โ•โ•โ•โ•โ•โ•โ•โ•โ•โ•โ•โ•โ•โ•โ•โ•โ•โ•โ•โ•โ•โ•โ•โ•โ•โ•โ•โ•โ•โ•โ•โ•โ•โ•โ•โ•โ•โ•โ•โ•โ•โ•โ•โ•โ•โ•โ•โ•โ•โ•โ•โ•โ•โ•โ•โ•โ•โ•โ•โ•โ•");
        ...
        if (!string.IsNullOrEmpty(_config.HonData?.HonInstallDirectory))
        {
            ...
            if (File.Exists(honExe))
            {
                ...
                Console.WriteLine($"  โ“ Found: {honExe}");
                Console.ResetColor();
            }
            else
            {
                Console.ForegroundColor = ConsoleColor.Red;
                Console.WriteLine("  โ— Warning: hon.exe not found in this directory");
                Console.ResetColor();
            }
        }
        ...
        Console.Write($"Hide server console window? (y/n) [{(_config.HonData.NoConsole ? "y" : "n")}]: ");
        ...
        Console.ForegroundColor = ConsoleColor.Yellow;
        Console.WriteLine("\nโ•”โ•โ•โ•โ•โ•โ•โ•โ•โ•โ•โ•โ•โ•โ•โ•โ•โ•โ•โ•โ•โ•โ•โ•โ•โ•โ•โ•โ•โ•โ•โ•โ•โ•โ•โ•โ•โ•โ•โ•โ•โ•โ•โ•โ•โ•โ•โ•โ•โ•โ•โ•โ•โ•โ•โ•โ•โ•โ•โ•โ•โ•โ•โ•—");
        Console.WriteLine("โ•‘                    Configuration Summary                      โ•‘");
        Console.WriteLine("โ•โ•โ•โ•โ•โ•โ•โ•โ•โ•โ•โ•โ•โ•โ•โ•โ•โ•โ•โ•โ•โ•โ•โ•โ•โ•โ•โ•โ•โ•โ•โ•โ•โ•โ•โ•โ•โ•โ•โ•โ•โ•โ•โ•โ•โ•โ•โ•โ•โ•โ•โ•โ•โ•โ•โ•โ•โ•โ•โ•โ•โ•โ•โ•");
        Console.ResetColor();

        Console.WriteLine("\nโ”โ”€ Installation โ”€โ”€โ”€โ”€โ”€โ”€โ”€โ”€โ”€โ”€โ”€โ”€โ”€โ”€โ”€โ”€โ”€โ”€โ”€โ”€โ”€โ”€โ”€โ”€โ”€โ”€โ”€โ”€โ”€โ”€โ”€โ”€โ”€โ”€โ”€โ”€โ”€โ”€โ”€โ”€โ”€โ”€โ”€โ”€โ”€โ”");
        Console.WriteLine($"โ”  HoN Install Dir:   {_config.HonData.HonInstallDirectory}");
        Console.WriteLine($"โ”  HoN Home Dir:      {_config.HonData.HonHomeDirectory}");
        Console.WriteLine($"โ”  HoN Logs Dir:      {_config.HonData.HonLogsDirectory}");
        
        Console.WriteLine("โ”โ”€ Server Identity โ”€โ”€โ”€โ”€โ”€โ”€โ”€โ”€โ”€โ”€โ”€โ”€โ”€โ”€โ”€โ”€โ”€โ”€โ”€โ”€โ”€โ”€โ”€โ”€โ”€โ”€โ”€โ”€โ”€โ”€โ”€โ”€โ”€โ”€โ”€โ”€โ”€โ”€โ”€โ”€โ”€โ”€โ”€โ”ค");
        Console.WriteLine($"โ”  Login:             {_config.HonData.Login}");
        Console.WriteLine($"โ”  Server Name:       {_config.HonData.ServerName}");
        Console.WriteLine($"โ”  Location:          {_config.HonData.Location}");
        Console.WriteLine($"โ”  Priority:          {_config.HonData.Priority}");
        
        Console.WriteLine("โ”โ”€ Server Instances โ”€โ”€โ”€โ”€โ”€โ”€โ”€โ”€โ”€โ”€โ”€โ”€โ”€โ”€โ”€โ”€โ”€โ”€โ”€โ”€โ”€โ”€โ”€โ”€โ”€โ”€โ”€โ”€โ”€โ”€โ”€โ”€โ”€โ”€โ”€โ”€โ”€โ”€โ”€โ”€โ”€โ”€โ”ค");
        Console.WriteLine($"โ”  Total Servers:     {_config.HonData.TotalServers}");
        Console.WriteLine($"โ”  Max Start at Once: {_config.HonData.MaxStartAtOnce}");
        Console.WriteLine($"โ”  Startup Timeout:   {_config.HonData.StartupTimeout}s");
        
        Console.WriteLine("โ”โ”€ Network Ports โ”€โ”€โ”€โ”€โ”€โ”€โ”€โ”€โ”€โ”€โ”€โ”€โ”€โ”€โ”€โ”€โ”€โ”€โ”€โ”€โ”€โ”€โ”€โ”€โ”€โ”€โ”€โ”€โ”€โ”€โ”€โ”€โ”€โ”€โ”€โ”€โ”€โ”€โ”€โ”€โ”€โ”€โ”€โ”€โ”€โ”ค");
        Console.WriteLine($"โ”  Game Port Start:   {_config.HonData.StartingGamePort}");
        Console.WriteLine($"โ”  Voice Port Start:  {_config.HonData.StartingVoicePort}");
        Console.WriteLine($"โ”  Manager Port:      {_config.HonData.ManagerPort}");
        Console.WriteLine($"โ”  API Port:          {_config.HonData.ApiPort}");
        
        Console.WriteLine("โ”โ”€ Connection โ”€โ”€โ”€โ”€โ”€โ”€โ”€โ”€โ”€โ”€โ”€โ”€โ”€โ”€โ”€โ”€โ”€โ”€โ”€โ”€โ”€โ”€โ”€โ”€โ”€โ”€โ”€โ”€โ”€โ”€โ”€โ”€โ”€โ”€โ”€โ”€โ”€โ”€โ”€โ”€โ”€โ”€โ”€โ”€โ”€โ”€โ”€โ”€โ”ค");
        Console.WriteLine($"โ”  Master Server:     {_config.HonData.MasterServer}");
        Console.WriteLine($"โ”  Patch Server:      {_config.HonData.PatchServer}");
        
        Console.WriteLine("โ”โ”€ Options โ”€โ”€โ”€โ”€โ”€โ”€โ”€โ”€โ”€โ”€โ”€โ”€โ”€โ”€โ”€โ”€โ”€โ”€โ”€โ”€โ”€โ”€โ”€โ”€โ”€โ”€โ”€โ”€โ”€โ”€โ”€โ”€โ”€โ”€โ”€โ”€โ”€โ”€โ”€โ”€โ”€โ”€โ”€โ”€โ”€โ”€โ”€โ”€โ”€โ”€โ”€โ”ค");
        Console.WriteLine($"โ”  Start on Launch:   {_config.HonData.StartOnLaunch}");
        Console.WriteLine($"โ”  Bot Matches:       {_config.HonData.EnableBotMatch}");
        Console.WriteLine($"โ”  No Console:        {_config.HonData.NoConsole}");
        Console.WriteLine($"โ”  Restart Between:   {_config.HonData.RestartBetweenGames}");
        Console.WriteLine($"โ”  Enable Proxy:      {_config.HonData.EnableProxy}");
        Console.WriteLine($"โ”  Use Cowmaster:     {_config.HonData.UseCowmaster}");
        Console.WriteLine("โ””โ”€โ”€โ”€โ”€โ”€โ”€โ”€โ”€โ”€โ”€โ”€โ”€โ”€โ”€โ”€โ”€โ”€โ”€โ”€โ”€โ”€โ”€โ”€โ”€โ”€โ”€โ”€โ”€โ”€โ”€โ”€โ”€โ”€โ”€โ”€โ”€โ”€โ”€โ”€โ”€โ”€โ”€โ”€โ”€โ”€โ”€โ”€โ”€โ”€โ”€โ”€โ”€โ”€โ”€โ”€โ”€โ”€โ”€โ”€โ”€โ”€โ”");
        ...
        {
            Console.ForegroundColor = ConsoleColor.Yellow;
            Console.WriteLine("\nโ  Configuration not saved. You can configure later via the dashboard.");
            Console.ResetColor();
        }
